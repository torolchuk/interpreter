...
import { a as assets, b as base } from "./paths.QnzqLOB5.js";
...
async function start(_app, _target, hydrate) {
  ...
  current_history_index = (_a = history.state) == null ? void 0 : _a[HISTORY_INDEX];
  current_navigation_index = (_b = history.state) == null ? void 0 : _b[NAVIGATION_INDEX];
...
function capture_snapshot(index) {
  if (components.some((c) => c == null ? void 0 : c.snapshot)) {
    snapshots[index] = components.map((c) => {
      var _a;
      return (_a = c == null ? void 0 : c.snapshot) == null ? void 0 : _a.capture();
    });
  }
}
function restore_snapshot(index) {
  var _a;
  (_a = snapshots[index]) == null ? void 0 : _a.forEach((value, i) => {
    var _a2, _b;
    (_b = (_a2 = components[i]) == null ? void 0 : _a2.snapshot) == null ? void 0 : _b.restore(value);
  });
}
...
async function load_node({ loader, parent, url, params, route, server_data_node }) {
  ...
  if ((_a = node.universal) == null ? void 0 : _a.load) {
...
async function load_route({ id, invalidating, url, params, route, preload }) {
  ...
  const invalid_server_nodes = loaders.map((loader, i) => {
    ...
    const invalid = !!(loader == null ? void 0 : loader[0]) && ((previous == null ? void 0 : previous.loader) !== loader[1] || has_changed(
      ...
      (_a = previous.server) == null ? void 0 : _a.uses,
      params
    ));
    if (invalid) {
      parent_invalid = true;
  ...
  const branch_promises = loaders.map(async (loader, i) => {
    ...
    const valid = (!server_data_node || server_data_node.type === "skip") && loader[1] === (previous == null ? void 0 : previous.loader) && !has_changed(
      ...
      url_changed,
      search_params_changed,
      (_a = previous.universal) == null ? void 0 : _a.uses,
      params
    );
    ...
    return load_node({
      ...
      parent: async () => {
        ...
        const data = {};
        for (let j = 0; j < i; j += 1) {
          Object.assign(data, (_a2 = await branch_promises[j]) == null ? void 0 : _a2.data);
        }
        return data;
      },
...
function _start_router() {
    ...
    if (hash2 !== void 0 && nonhash === strip_hash(location)) {
      ...
      if (current_hash === hash2) {
        ...
        if (hash2 === "" || hash2 === "top" && a.ownerDocument.getElementById("top") === null) {
          ...
          (_a2 = a.ownerDocument.getElementById(hash2)) == null ? void 0 : _a2.scrollIntoView();
        }
        return;
      }
  ...
  addEventListener("popstate", async (event) => {
    var _a2;
    if ((_a2 = event.state) == null ? void 0 : _a2[HISTORY_INDEX]) {
...
function create_navigation(current2, intent, url, type) {
  ...
  const navigation = {
    from: {
      ...
      route: { id: ((_a = current2.route) == null ? void 0 : _a.id) ?? null },
      url: current2.url
    },
    to: url && {
